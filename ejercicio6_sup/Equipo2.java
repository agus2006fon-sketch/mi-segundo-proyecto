...
public class Equipo2 {
    ...
    private int GContra;
    //constructor
    public Equipo2 (String nom,Jugador2 cap){
        nombre=nom;
        capitan=cap;
        pE=0;
        pG=0;
    ...
    public Jugador2 obtenerCapitan(){
        return capitan;
    }
    ...
    public Equipo2 mejorPuntaje(Equipo2 e){
    ...
    public Jugador2 capitanConMasGoles(Equipo2 e){
    ...
    public boolean equals(Equipo2 e){
        boolean eq=false;
        if(e!=null){ 
          eq=nombre==e.obtenerNombre() && 
          capitan==e.obtenerCapitan() && 
          pG==e.obtenerPG() && 
          pE==e.obtenerPE() && 
          pP==e.obtenerPP();
        }
